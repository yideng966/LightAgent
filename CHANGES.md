...
- Web 技能页将在线目录迁移到独立二级弹窗，支持搜索、风险和分类筛选、12 条分页、技能详情及安装操作；主页面不再随在线技能数量增长而拉长。
...
- Playwright 在 1440×900 与 390×844 视口完成主页面、在线技能库和详情弹窗验收；移动端无横向溢出，并完成 `hello-lightagent` 在线安装、状态刷新和卸载入口闭环。
