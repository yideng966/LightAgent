...
Source reliability for web materials:
- Prefer navigation links actually exposed on the page over guessed documentation paths.
- Only record URLs that were successfully fetched as Source in knowledge pages.
- 404/410, failed requests, or guessed paths must not be written as sources; if a page cannot be found, say so instead of saving unreliable content.
...
For web sources, only use a URL here after it was successfully fetched or opened. Do not use guessed, failed, or 404/410 URLs as Source values.
