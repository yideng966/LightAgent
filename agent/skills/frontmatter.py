...
def parse_metadata(frontmatter: Dict[str, Any]) -> Optional[SkillMetadata]:
    ...
    # Unwrap nested namespace (e.g. {"openclaw": {...}} or {"lightagent": {...}})
...
_KNOWN_METADATA_NAMESPACES = {"lightagent", "openclaw"}


def _unwrap_metadata_namespace(metadata_raw: Dict[str, Any]) -> Dict[str, Any]:
    """
    Unwrap a single-key namespace wrapper like {"lightagent": {...} or {"openclaw": {...}}}.
