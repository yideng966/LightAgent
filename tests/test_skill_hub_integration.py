...
class SkillHubIntegrationSurfaceTest(unittest.TestCase):
    def test_web_route_and_management_controls_are_present(self):
        ...
        self.assertIn("id=\"skill-hub-community\"", html)
        self.assertIn("https://github.com/xiaoguiwucan/LightAgent-SkillHub", html)
        self.assertIn("LightAgent-SkillHub/blob/main/CONTRIBUTING.md", html)
        self.assertIn("LightAgent-SkillHub/pulls", html)
        self.assertIn("skill_hub_community_desc", frontend)
        self.assertIn("skill_hub_pull_requests", frontend)
