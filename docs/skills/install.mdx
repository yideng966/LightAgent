...
LightAgent supports installing skills from the signed [LightAgent Skill Hub](https://yideng966.github.io/LightAgent-SkillHub/), GitHub, ClawHub, LinkAI, and any URL via a unified `install` command. Use `/skill install` in chat or `lightagent skill install` in the terminal.

## From the Skill Hub

Browse all available skills at [Skill Hub](https://yideng966.github.io/LightAgent-SkillHub/) and install by name:
