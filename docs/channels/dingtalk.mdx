---
title: DingTalk
description: Integrate LightAgent into DingTalk application
---

Integrate LightAgent into DingTalk by creating an intelligent robot app on the DingTalk Open Platform.
