...
description: Channels supported by LightAgent and their capability matrix
---

LightAgent supports multiple chat channels. Switch between them at startup via `channel_type`. The Web Console is enabled by default and can run in parallel with other channels.
