...
| --- | --- | --- |
| [2.2.1](/releases/v2.2.1) | 2026.08.01 | WeChat group: sticker/image type separation, free reply image failure fallback, silent-control text no longer leaked to group chat; Wechat4u contact sync dedup |
| [2.2.0](/releases/v2.2.0) | 2026.07.31 | Baseline restored to 2.1.18 stable; Chinese contribution guide and Docker multi-arch manifest publish race fix retained |
| [2.1.21](/releases/v2.1.21) | 2026.07.31 | Fix Docker multi-arch manifest cleanup race preventing skills-full publish |
| [2.1.18](/releases/v2.1.18) | 2026.07.29 | WeChat group: stable CN output for long-term memory; group member profile learning UI layout stability |
| [2.1.17](/releases/v2.1.17) | 2026.07.28 | WeChat group: join/leave notifications on by default; group permanent memory migrated to memory system with continuous generation |
