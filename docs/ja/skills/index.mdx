---
title: スキル概要
description: LightAgent のスキルシステム紹介
---
...
LightAgent ではスキルを取得する複数の方法を提供しています：

- **LightAgent スキル広場** — `/skill list --remote` でコミュニティスキルを閲覧・インストール
...
1. **ワークスペースのスキル**（最高優先）：`~/lightagent/skills/`
