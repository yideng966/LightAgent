...
[LightAgent Skill Hub](https://skills.cowagent.ai/) は、公式推奨・コミュニティ貢献・サードパーティ（GitHub、ClawHub など）のスキルを集約した、オープンソースの AI Agent スキルマーケットプレイスです。

ソースコード: [github.com/zhayujie/lightagent-skill-hub](https://github.com/zhayujie/cow-skill-hub)
...
- **ワンクリックインストール** — インストールコマンドをコピーして LightAgent で実行
...
1. [Skill Hub/submit](https://skills.cowagent.ai/submit) にアクセス
