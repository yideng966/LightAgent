...
[LightAgent Skill Hub](https://skills.cowagent.ai/) 是开源的 AI Agent 技能广场，汇集了官方推荐、社区贡献和第三方平台（GitHub、ClawHub 等）的技能。

开源仓库：[github.com/zhayujie/lightagent-skill-hub](https://github.com/zhayujie/cow-skill-hub)
...
1. 访问 [Skill Hub/submit](https://skills.cowagent.ai/submit)
