...
> Coding Plan is a monthly subscription package offered by various providers, ideal for high-frequency Agent usage. LightAgent supports all Coding Plan providers via OpenAI-compatible mode.
